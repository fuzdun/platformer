...
game_update :: proc(gs: ^st.Game_State, lrs: st.Level_Resources, pls: ^st.Player_State, ps: ^st.Physics_State, rs: ^st.Render_State, elapsed_time: f64, delta_time: f32) {game
    //fmt.println("============update===========")
    if EDIT {
