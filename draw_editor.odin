...
draw_editor :: proc(rs: ^Render_State, bs: Buffer_State, shs: ^Shader_State, es: Editor_State, is: Input_State, lgs: [dynamic]Entity, rg: Render_Groups, proj_mat: glm.mat4) {
