...
transformed_vertex :: proc(vertex: typ.Vertex, trns: typ.Transform) -> typ.Vertex {
...
get_ssbo_idx :: proc(lg: typ.Level_Geometry, shader: enm.ProgramName, rs: st.Render_State) -> int {
