...
INIT_PLAYER_POS :: [3]f32 { -10, 20, 0 }

// move speed
MAX_PLAYER_SPEED: f32: 15.0
...
GROUND_ACCEL: f32: 400.0
WALL_ACCEL: f32: 400.0
AIR_ACCEL: f32: 800.0
SLOPE_ACCEL: f32: 400.0


// FAST_CUTOFF: f32: 15.0
MED_CUTOFF: f32: 40.0
...
when ODIN_OPTIMIZATION_MODE == .Speed {
    PLAYER_SPIN_PARTICLE_COUNT :: 1000

} else {
    PLAYER_SPIN_PARTICLE_COUNT :: 100
}
